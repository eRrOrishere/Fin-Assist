	  		...
	  		<div class="row center">
	  			<div class="col s6 spanel">
	  				<div class="card-panel">
	  					<a href="medical_auth.php" class="black-text">Cash Flow</a>
	  				</div>
	  			</div>
	  			<div class="col s6 spanel">
	  				<div class="card-panel">
	  					<a href='ngo.php' class="black-text">Asset Management</a>
	  				</div>
	  			</div>
	  			<div class="col s6 spanel">
	  				<div class="card-panel">
	  					<a href='swd.php' class="black-text">Bank Reports</a>
	  				</div>
	  			</div>
	  			<div class="col s6 spanel">
	  				<div class="card-panel">
	  					<a href='swd.php' class="black-text">Liabilities</a>
	  				</div>
	  			</div>
                <div class="col s6 spanel">
	  				<div class="card-panel">
	  					<a href='swd.php' class="black-text">Risk Management</a>
	  				</div>
	  			</div>
                <div class="col s6 spanel">
	  				<div class="card-panel">
	  					<a href='swd.php' class="black-text">Action Plan</a>
	  				</div>
	  			</div>
	  		</div>
	  	</div>>
